...
from lib.zenyxd import zenyxDaemon
import zenyxlib
from decimal import Decimal

zenyxd = zenyxDaemon.from_zenyx_conf(config.zenyx_conf)
import misc
...
pr = Proposal(
    name="proposal7",
    url="https://zenyxcentral.com/proposal7",
